...
def main():
    ...
    for a in range(2, 101):
        ...
        for b in range(2, 101):
            a_b_result = a_factors.copy()
            for this_prime, this_power in a_factors.items():
                a_b_result[this_prime] = this_power * b
            all_terms.add(json.dumps(a_b_result, sort_keys=True))
    print(len(all_terms))
